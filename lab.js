...
//Code here
favoriteThings['car'] = 'Porche 918 Spyder';
favoriteThings.brand = 'NASA';
...
fred = new Cat('fred', 8, 'white & orange');
...
megumin = new Wizard('megumin', 14, 'Explosion');
...
//Code Here
hisPhone = new Phone('Apple', 'iPhone XR', 64, 'black', 800);
herPhone = new Phone('Nokia', 'Indestructable+', 2, 'blue', 50);
myPhone = new Phone('Samsung','Galaxy S9', 64, 'Black', 300);
/* 
...
//Code Here
ranger = new Vehicle(2, 'White', 125000);
ranger.move(15);
...
//Code Here 
myFirstMotorcyle = new Motorcycle(1, 'red', 1223332, true, 'Suzuki');
/*
  Call the move function on myFirstMotorcycle (don't forget the parameter)
*/
myFirstMotorcyle.move(33);
/*
...
//Code Here
myFirstBoat = new Boat(7, 'white', 15000, 'Minnow', 'Yacht', false);
/*
